...
| J3         | Blue            | 1 SW 7    | 7            |                   | **P1 B7 - Bottom Bottom L** | L-Shift          | **P1 Ltrig**           | Changed to map the physical differences with the XGaming |
| J3         | Green           | 1 SW 8    | 7            |                   | **P1 B8 - Bottom Bottom R** | Z                | **P1 Rtrig**           |                                                          |
| J3         | Yellow          | Start 1   | 8            |                   | P1 Start                    | 1                | P1 Button 8 (Start)    |                                                          |
| J3         | Orange          | Start 2   | 8            |                   | P2 Start                    | 2                | P2 Button 8 (Start)    |                                                          |
| J3         | Red             | Coin 1    | 9            |                   | **Pinball Left**            | 5                | P1 Home                | Changed to map the physical differences with the XGaming |
| J3         | Brown           | Coin 2    | 9            |                   | **Pinball Right**           | 6                | P2 Home                | Changed to map the physical differences with the XGaming |
| Empty      |                 |           | 10           |                   |                             |                  |                        |                                                          |
...
| J1         | Blue            | 2 SW 7    | 6            |                   | **P2 B7 - Bottom Bottom L** | L-Shift          | **P2 Ltrig**           | Changed to map the physical differences with the XGaming |
| J1         | Green           | 2 SW 8    | 6            |                   | **P2 B8 - Bottom Bottom R** | Z                | **P2 Rtrig**           | Changed to map the physical differences with the XGaming |
| J1         | Yellow          | 1A        | 7            |                   | **Back Button**             | P                | **P1 Button 7 (Back)** | Changed to map the physical differences with the XGaming |
| J1         | Orange          | 1B        | 7            |                   | Not connected               | Enter            | P1 Home                | Changed to map the physical differences with the XGaming |
