...
| J3         | Blue            | 1 SW 7    | 7            |                   | Spinner A                   | L-Shift          | P1 Button 4 (Y)     |                              |
| J3         | Green           | 1 SW 8    | 7            |                   | Spinner B                   | Z                | P1 Button 5 (LR)    |                              |
| J3         | Yellow          | Start 1   | 8            |                   | P1 Start                    | 1                | P1 Button 8 (Start) |                              |
| J3         | Orange          | Start 2   | 8            |                   | P2 Start                    | 2                | P2 Button 8 (Start) |                              |
| J3         | Red             | Coin 1    | 9            |                   | Coin One                    | 5                | P1 Home             |                              |
| J3         | Brown           | Coin 2    | 9            |                   | Coin Two                    | 6                | P2 Home             |                              |
| Empty      |                 |           | 10           |                   |                             |                  |                     |                              |
| J2         | Grey            | 2 RIGHT   | 1            | Outside           | P2 Right                    | G                | P2 Dpad-R           | Changed to match the diagram |
| J2         | Purple          | 2 LEFT    | 1            | Inside            | P2 Left                     | D                | P2 Dpad-L           | Changed to match the diagram |
| J2         | Blue            | 2 UP      | 2            |                   | P2 Up                       | R                | P2 Dpad-U           | Changed to match the diagram |
| J2         | Green           | 2 DOWN    | 2            |                   | P2 Down                     | F                | P2 Dpad-D           | Changed to match the diagram |
...
| J1         | Blue            | 2 SW 7    | 6            |                   | 4 Way A2                    | L-Shift          | P1 Button 4 (Y)     |                              |
| J1         | Green           | 2 SW 8    | 6            |                   | 4 Way B2                    | Z                | P1 Button 5 (LR)    |                              |
| J1         | Yellow          | 1A        | 7            |                   | Pause                       | P                | P1Roy-L             |                              |
| J1         | Orange          | 1B        | 7            |                   | Select                      | Enter            | P1 Home             |                              |
| J1         | Red             | 2A        | 8            |                   | Menu                        | Tab              | P2 Button 10        |                              |
| J1         | Brown           | 2B        | 8            |                   | Exit                        | Esc              | P2 Button 9         |                              |
